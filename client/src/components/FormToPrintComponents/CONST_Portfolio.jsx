...
// items used in the Grids

export const items2_7 = ["Project Lead",
...
export const items2_7b = ["Project Lead",
    "Zach Atkinson",
    "Perfomance Period",
    "2020",
    "Target Audience",
...
export const items2_7c = ["Project Lead",
    "Zach Atkinson",
    "Perfomance Period",
    "2020",
    "Target Audience",
...
export const module5B = ["TASKS & OBJECTIVES",
    "DELIVERABLES",
...
export const module5E = [
    "TASKS & OBJECTIVES",
    "DELIVERABLES",
    "● Page by-page Perfonmance Optimized with Lighthouse Tests",
    "● Perfomance summary report",
    "● Comprehensive Page-by-Page WCAG 2.0 AA Tests. Through a combination of open source and paid 3 rd party tools, we perform a page - by - page analysis ensuring the site meets WCAG 2.0 AArequiremetns.",
    "● Accesibility summary report",
    "● Final Feedback Changes",
    ""]

export const module5F = [
    "TASKS & OBJECTIVES",
    "DELIVERABLES",
    ...
    "● Submission of final report outlining work completed, costs and work remaining"]

export const module5G = [
    "TASKS & OBJECTIVES",
    "DELIVERABLES",
    "● Website Launch",
    "● Website Launch",
